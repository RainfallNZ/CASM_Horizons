...
CombinedClasses$NewRate <- with(CombinedClasses, (LeachRates * Area_hectares + NodeAveLeachRate * AreaDiff) / TotalNodeArea)
...
saveWorkbook(Out, file.path(DataDirectory,"CASM-Inputs_IntensiveOperativeTable14_2Year5OrConsentedWithCoxCalibrated.xlsx"), overwrite = T)
```
