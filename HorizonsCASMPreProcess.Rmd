...
#Note that data_long is a tbble, not a data frame which confuses me.
...
saveWorkbook(Out, file.path(DataDirectory,"CASM-Inputs_Horizons_Scenario5_11PctDairyExpanseOperativeTable14_2Year20WithCoxCalibratedB.xlsx"), overwrite = T)
```
