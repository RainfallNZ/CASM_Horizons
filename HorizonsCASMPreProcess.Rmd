...
HorizonsPropertyData <- HorizonsPropertyData[,c(3,15,23:30,47:58)]
...
saveWorkbook(Out, file.path(DataDirectory,"CASM-Inputs_Horizons_Scenario5_Intensive11PctDairyExpanseOperativeTable13_2Year20WithCoxCalibrated.xlsx"), overwrite = T)
```
