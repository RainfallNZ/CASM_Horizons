...
LeachRate <- raster(file.path(GISDataDirectory,LeachRateRasterFile))

#Or get it from one of the scenario leachrate rasters I have created. 
LeachRate <- stack(file.path(GISDataDirectory,LeachRateRasterFile))[[1]]
#LeachRate <- stack(file.path(GISDataDirectory,"ScenarioLeachRasters_IntensiveLanduseTable4-2.tif"))[[1]]
#LeachRate <- stack(file.path(GISDataDirectory,"ScenarioLeachRastersFullTable4-2.tif"))[[1]]
...
saveWorkbook(Out, file.path(DataDirectory,"CASM-Inputs_check.xlsx"), overwrite = T)
```
