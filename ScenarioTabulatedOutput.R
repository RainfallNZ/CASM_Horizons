...
X8bFile <- file.path(DataDirectory,"CASM-Inputs_Horizons_Scenario8b_IntensiveTable14_2Year20OrConsentedOrFedFarmGeneralisedWithCoxCalibrated.xlsx")               #Horizons "Scenario 8, Fed. Farmers.
...
X12File <- file.path(DataDirectory,"CASM-Inputs_Horizons_Scenario12_ConsentedOrBaseOrCoxCalibratedV2.xlsx") #Horizons "Scenario 12" 
...
Scenarios <- c("Baseline","Scenario0_a" ,"Scenario0_b", "Scenario1_a", "Scenario1_b", "Scenario2_a",
               "Scenario2_d" ,"Scenario3_e", "Scenario3_h", "X4","X5","X6","X7","X8","X8b","X9a","X9b","X10","Ton","X12","X13","X3i","X3j","X3k","X3l","X12b","X13b")
...
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "Scenario0_b",Reference = "X12b", stringsAsFactors = FALSE))
...
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "Scenario3_h",Reference = "X10", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3i",Reference = "Scenario0_b", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3i",Reference = "Scenario1_b", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3i",Reference = "Scenario3_e", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3j",Reference = "Scenario0_b", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3j",Reference = "Scenario1_b", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3j",Reference = "Scenario3_h", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3k",Reference = "X3i", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3l",Reference = "X3j", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3k",Reference = "X12b", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X3l",Reference = "X12b", stringsAsFactors = FALSE))
...
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X8",Reference = "Scenario3_e", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X8",Reference = "Scenario3_h", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X8b",Reference = "Scenario1_b", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X8b",Reference = "X3i", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X8b",Reference = "X3j", stringsAsFactors = FALSE))
...
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X12b",Reference = "X6", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X12b",Reference = "X12", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X13",Reference = "Baseline", stringsAsFactors = FALSE))
ScenarioPairs <- rbind(ScenarioPairs,data.frame(Comparison = "X13b",Reference = "X13", stringsAsFactors = FALSE))
